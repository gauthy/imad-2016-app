function loadLoginForm () {
    var loginHtml = `
        ...
        <input type="text" id="username" placeholder="username" style="background-color:Black; color:Lime;" />
        <input type="password" id="password" placeholder="password" style="background-color:Black; color:Lime;" />
        <br/><br/>
